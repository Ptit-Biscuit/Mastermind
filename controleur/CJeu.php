...
class CJeu {
    ...
    public static function validate() {
	    if($_SESSION['jeu']->isFinished()) VJeuFini::gameOver(); // le jeu est terminé : on affiche l'écran de victoire ou de défaite
	    else VJeu::displayGame($_SESSION['jeu']->getBoard()); // le jeu continue !
    }
